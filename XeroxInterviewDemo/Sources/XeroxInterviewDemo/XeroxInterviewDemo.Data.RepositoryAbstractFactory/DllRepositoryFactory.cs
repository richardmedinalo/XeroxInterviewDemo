...
namespace XeroxInterviewDemo.Data.RepositoryAbstractFactory
{
    ...
    /// <summary>
    /// We can create a plugin as dll and load it using Reflection for using an external storing system.
    /// </summary>

    public class DllRepositoryFactory : IRepositoryFactory
    {
        ...
        public DllRepositoryFactory (bool loadFromDefaultDll) : 
        ...
        public DllRepositoryFactory(string filename, string repositoryContextFullname)
        {
            _filename = filename;
